  ...
  return (
    <>
      <div className='w-[75%] flex flex-wrap justify-between items-center gap-10 my-10 mx-auto'>
        {data.map((item) => {
          return <div className='bg-black relative w-[35vw] h-[60vh] my-10'>
         ...
         <div className='flex justify-center items-center w-full mb-10'>
            <div className='capitalize bg-yellow-400 flex items-center justify-between px-6 py-3 gap-2 pb-shadow'>
               <span>load more</span> 
               <span pl-button>
               <svg width="16px" height="16px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
