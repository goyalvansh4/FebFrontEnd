...
<div className='lg:w-[50%] w-[99%] mx-auto md:flex justify-center items-center md:h-full lg:my-1 my-10 lg:px-1 px-5'>
  <div className='bg-[#1136FF] p-10 a-shadow'>
    <div>
      <p className='md:text-6xl text-xl text-white font-bold border-b-4 capitalize'>latest project</p>
    </div>

    <div className='text-white flex gap-4 text-lg font-semibold md:py-5 capitalize'>
      <a href="#">
        Home
      </a>
      <p>&gt;</p>
