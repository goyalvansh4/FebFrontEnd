    ...
    <>
      <div className='bg-white w-full md:h-screen mb-10'>
        <div className='h-[80%] w-[90%] m-auto bg-[#1136FF] a-shadow md:flex'>
          ...
          <div >
              <span className='text-xl capitalize text-black font-bold bg-white text-center px-2 py-2 a-shadow-sm rounded '>our newsletter</span>

            </div>
            <p className='text-white md:text-4xl text-2xl font-semibold '>Get Every Single Updates Newsletter Subscribe</p>
