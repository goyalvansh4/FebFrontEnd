...
const febItems = [
  {
    ...
    res: [
      ...
      "Professional Development: We encourage our employees to continue learning and growing in their field by providing opportunities htmlFor professional development.",
  ...
  {
    perks: "our culture",
    para: "At FEB TECH IT SOLUTIONS, our culture is a reflection of our values and our commitment to excellence. We are a team of passionate professionals who work together to provide innovative and reliable solutions to our clients.Our culture is built on respect, integrity, and collaboration.We believe in fostering an inclusive environment where every team member has a voice and is valued htmlFor their unique perspectives and contributions.We encourage learning and growth, both professionally and personally, and support our team members in their pursuit of success.",
    res: [],
    lpara:
      "We believe that a healthy work- life balance is essential htmlFor overall well - being, which is why we offer flexible work arrangements and other benefits to support our team members.We also believe in giving back to our community and regularly participate in social and environmental initiatives.At FEB TECH, we strive to create a positive and fulfilling work experience htmlFor our team members, which in turn translates into exceptional service and solutions htmlFor our clients.",
  },
  {
    perks: "join our team",
