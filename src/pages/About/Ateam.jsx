    ...
    <>
     <div className='flex flex-col gap-2  pb-5 pt-10 my-5 '>
        ...
        <div className='flex justify-center pb-8'>
            ...
            <p className='2xl:text-4xl lg:w-[60%] mx-auto text-2xl leading-loose font-light'>Our passionate professionals are committed to delivering exceptional services to our clients.</p>
            </div>
